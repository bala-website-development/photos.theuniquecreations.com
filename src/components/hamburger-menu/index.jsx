          ...
          <div className="off-canvas-item">
            <div className="asside-navigation-area">
              <ul className="asside-menu">
                ...
                <li className="dropdown-submenu d-none">
                  <NavLink to={process.env.PUBLIC_URL + "/portfolio"}>
                    <span>Portfolio</span>
                  </NavLink>
                  <span className="menu-toggle" onClick={onClickHandler} aria-hidden="true"></span>
                  <ul className="dropdown-nav">
                    <li>
                      <NavLink to={process.env.PUBLIC_URL + "/portfolio"}>Portfolio</NavLink>
                    </li>
                    <li>
                      <NavLink to={process.env.PUBLIC_URL + "/portfolio-details/1"}>Portfolio Details</NavLink>
                    </li>
                  </ul>
                </li>
                <li>
                ...
                <li className="">
                  <NavLink to={process.env.PUBLIC_URL + "/video-gallery"}>Video</NavLink>
                </li>
                <li>
                ...
                <li className="dropdown-submenu d-none">
                  ...
                  <ul className="dropdown-nav">
                    <li>
                      <NavLink to={process.env.PUBLIC_URL + "/blog"}>Blog Grid</NavLink>
                    </li>
                    <li>
                      <NavLink to={process.env.PUBLIC_URL + "/blog-details/1"}>Blog Details</NavLink>
                    </li>
                  </ul>
                </li>
              </ul>
